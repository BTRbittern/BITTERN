Contributing to Bittern Core
============================

The Bittern Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bittern Core project, and is not to be
confused with overall BTR Network Protocol consensus changes.

Whether a pull request is merged into Bittern Core rests with the project merge
...
Patches that change BTR consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTR consensus, it must have been
...
The project leader is the release manager for each Bittern Core release.
