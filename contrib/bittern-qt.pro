...
RESOURCES += src/qt/bittern.qrc src/qt/bittern_locale.qrc

TRANSLATIONS += src/qt/locale/bittern_bg.ts \
                src/qt/locale/bittern_de.ts \
                src/qt/locale/bittern_en.ts \
                src/qt/locale/bittern_es.ts \
                src/qt/locale/bittern_fi.ts \
                src/qt/locale/bittern_fr.ts \
                src/qt/locale/bittern_it.ts \
                src/qt/locale/bittern_ja.ts \
                src/qt/locale/bittern_pl.ts \
                src/qt/locale/bittern_pt.ts \
                src/qt/locale/bittern_ru.ts \
                src/qt/locale/bittern_sk.ts \
                src/qt/locale/bittern_sv.ts \
                src/qt/locale/bittern_vi.ts \
                src/qt/locale/bittern_zh_CN.ts \
                src/qt/locale/bittern_zh_TW.ts
