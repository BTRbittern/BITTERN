...
BTR now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bittern_address\> \<monthly_payment_bittern\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ BTR, _12_ times over the course of a year totaling _24000_ BTR.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bittern_address\> \<monthly_payment_bittern\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` BTR.
 ...
 * vote-many          - Vote on a BTR initiative
 * vote-alias         - Vote on a BTR initiative
 * vote               - Vote on a BTR initiative/budget
