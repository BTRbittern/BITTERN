...
In order to support loading of multiple wallets in bittern-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bittern.cpp.
...
Changes to bittern.cpp
----------------------
bittern.cpp is the entry point into bittern-qt, and as such, will require some minor modifications to provide hooks for
