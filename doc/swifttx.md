...
This mechanism has been integrated into Bitcore-Node-BTR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BTR-Project/insight-api-bittern#web-socket-api](https://github.com/BTR-Project/insight-api-bittern#web-socket-api) 
* API: [https://github.com/BTR-Project/insight-api-bittern#swifttx-transactions](https://github.com/BTR-Project/insight-api-bittern#swifttx-transactions) 
...
By default, the Bittern Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bittern Core daemon:
