...
#   c) node1 mines 32 blocks, so now node 0 has 60001bittern, node 1 has 4250bittern, node2 has none.
#   d) node0 sends 601 bittern to node2, in two transactions (301 bittern, then 300 bittern).
