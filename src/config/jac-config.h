/* src/config/bittern-config.h.  Generated from bittern-config.h.in by configure.  */
/* src/config/bittern-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "bittern.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "J Active Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "J Active Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bittern"
