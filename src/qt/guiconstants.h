...
/* Bittern GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BTR"
#define QAPP_ORG_DOMAIN "bittern.org"
#define QAPP_APP_NAME_DEFAULT "Bittern-Core"
#define QAPP_APP_NAME_TESTNET "Bittern-Core-testnet"
