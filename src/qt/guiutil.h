...
/** Utility functions used by the BTR Qt UI.
 */
namespace GUIUtil
{
...
// Render BTR addresses in monospace font
...
// Parse "bittern:" URI into recipient object, return true on successful parsing
