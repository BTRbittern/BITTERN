...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTR features */
        {"bittern", "masternode", &masternode, true, true, false},
        {"bittern", "listmasternodes", &listmasternodes, true, true, false},
        {"bittern", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bittern", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bittern", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bittern", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bittern", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bittern", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bittern", "masternodedebug", &masternodedebug, true, true, false},
        {"bittern", "startmasternode", &startmasternode, true, true, false},
        {"bittern", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bittern", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bittern", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bittern", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bittern", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bittern", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bittern", "mnsync", &mnsync, true, true, false},
        {"bittern", "spork", &spork, true, true, false},
        {"bittern", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bittern-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42020/\n";
}
