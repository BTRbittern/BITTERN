...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4,       // ONLY_NONDENOMINATED and not 2500 BTR at the same time
...
public:
    ...
    string GetUniqueWalletBackupName(bool fzbtrAuto) const;
    ...
    // Get 1000 output and keys which can be used for the Masternode
